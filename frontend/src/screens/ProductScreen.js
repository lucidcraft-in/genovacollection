...
const ProductScreen = ({ history, match }) => {
  ...
  let productName = product.name?.replaceAll(' ', '%20');
  let userName = userInfo?.name?.replaceAll(' ', '%20');
            ...
            <Col md={6}>
              ...
              <Row className="m-3">
                ...
                <Col md={9} sm={12}>
                  ...
                  &nbsp;
                  <a
                    href={`whatsapp://send?text=Hello%20Genova%20Collections,%20I%20am%20${userName},%20I%20like%20to%20purchase%20your%20product%20%20${productName}:%20[%20size:%20${selectedSize},%20color:%20${selectedColor}]&phone=+971 52 462 4241`}
                  >
                    <Button
